...
{
    protected $view = 'arvi.frontend.store.my-order.';
    ...
    public function index($code)
    {
        $orders = DB::table('merchant_orders')
            ...
            ->get();
        return view($this->view.'page-my-order',compact('orders','code'));
    }
    ...
    public function show(Request $request,$code)
    {
        ...
        return view($this->view.'page-my-order-detail',compact('order','fees','code'));
    }
