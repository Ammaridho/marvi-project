...
{
    protected $view = 'arvi.frontend.oobe-indonesia.check-out.';
    ...
    public function paymentOrder(Request $request)
    {
        if (!isset($request->data)) {
            ...
            $bioCust                = json_encode($request->bioCust);
            $deliveryId             = $request->deliveryId;
            $courier                = json_encode($request->courier);
    ...
    public function paymentProcess(Request $request)
    {
        ...
        return redirect()->route('payment-store-detail',['data' => json_encode($data)]);
    ...
    function detail(Request $request)
    {
        ...
        switch ($data['payment']['category']) {
            ...
            case 'CASH':
                return view('arvi.frontend.oobe-indonesia.result-payment.cash.page-payment-cash',
                compact('data'));
                break;
            case 'VIRTUAL_ACCOUNT':
                return view('arvi.frontend.oobe-indonesia.result-payment.va.page-payment-va',
                compact('data'));
                break;
            case 'EWALLET':
                return view('arvi.frontend.oobe-indonesia.result-payment.ew.page-payment-ew',
                compact('data'));
                break;
            case 'QR_CODE':
                return view('arvi.frontend.oobe-indonesia.result-payment.qr.page-payment-qr',
                compact('data'));
                break;
            case 'RETAIL_OUTLET':
                return view('arvi.frontend.oobe-indonesia.result-payment.ro.page-payment-ro',
                compact('data'));
                break;
        }
    }
    ...
    public function generateCash(Request $request)
    {
        ...
        return redirect()->route(
            'payment-invoice',['data' => json_encode($data)]
        );
    }
    ...
    public function generateQr(Request $request)
    {
        ...
        return view('arvi.frontend.oobe-indonesia.result-payment.qr.page-payment-generate-qr',
        compact('data','qr_string'));
    }

    public function generateEw(Request $request)
    {
        $data         = json_decode($request->data);
        ...
        $name         = $data->payment->name;
        $totalPrice   = $data->payment->totalPrice;
        $linkSuccess  = route('payment-store-success');
        $linkFailed   = route('payment-store-failed');
    ...
    public function generateRo(Request $request)
    {
    ...
    {
        $data = json_decode($request->data);
        return view('arvi.frontend.oobe-indonesia.result-payment.invoice',
        compact('data'));
    }
    ...
    function failed(Request $request)
    {
        ...
        return view('arvi.frontend.oobe-indonesia.result-payment.page-payment-failed',
            compact('totalPrice','currency','payment'));
    }
    ...
    function success(Request $request)
    {
        ...
        return view('arvi.frontend.oobe-indonesia.result-payment.page-payment-success',
            compact('totalPrice','currency','payment'));
    }
