...
{
    protected $view = 'arvi.frontend.oobe-indonesia.shopping-cart.';
    ...
    public function index(Request $request)
    {
        ...
        if (isset($cart)) {
            ...
            foreach ($cart as $key => $value) {
                ...
                if (MerchantProductVariant::find($value['variant']['id'])) {
                    ...
                    $variant['price'] = 
                    MerchantProductVariant::find($value['variant']['id'])->retail_price;
                }else{
                    $variant = null;
                }
        ...
        compact('shoppingCarts','countUniqStore'));
