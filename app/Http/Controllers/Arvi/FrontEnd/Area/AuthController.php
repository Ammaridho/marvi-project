...
class AuthController extends Controller
{
    ...
    protected $view = 'arvi.frontend.area.account.';
    ...
    public function login(Request $request,$code)
    {
        ...
        if (Auth::attempt($validator,$remember_me)) {
            ...
            return redirect()->route('index-area',['code'=>$code]);
        }
        return redirect()->route('login-area',['code'=>$code])
    ...
    public function store(Request $request,$code)
    {
        ...
        if (isset($request->data['name'])) {
            ...
            if (Auth::attempt(['phone_number' => $request->data['phone'],
                ...
                $user = auth()->user();
                $request->session()->regenerate();
                return redirect()->route('thankyou-area',['code'=>$code]);
            }
            return redirect()->route('login-area',['code'=>$code])
    ...
    public function checkPhoneNumber(Request $request,$code)
    {
        ...
        return view($this->view.'page-otp',
            compact('data','code'));
    }
    ...
    public function inputNewPassword(Request $request,$code)
    {
        ...
        return view($this->view . 'page-new-password',
            compact('phone_number','code'));
    }
