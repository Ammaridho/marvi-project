        ...
        <div class="row text-center d-flex align-items-center p-4">
            ...
            <div class="card no-border">
                <div class="card-body border-0 py-4">
                    <div class="mb-4">
                        <img src="/arvi/assets/img/small-time-mark.svg" type="image/svg+xml" class="w-25" />
                    </div>
                    <h2>Waiting Payment.</h2>
                    <div>We're waiting your payment.</div>
                    ...
                    <div class="p-5">
                        <a href="../m/mrcasdfghjkl" class="btn btn-theme-secondary col">back to shop</a>
                    </div>
                    <!-- //Success page -->
