                        ...
                        <div class="d-flex">
                            <div>
                                @if (isset($merchant->image_url))
                                    ...
                                    style="background-image: url('/arvi/backend-assets/img/logo/merchants/{{$merchant->image_url}}')">
                                @else
                                    <div class="py-2 px-4 border rounded img-brand-logo" 
            ...
            <div class="menu-warp">
                <ul class="list-inline m-0 p-0 merchant-list-menu">
                    @foreach ($categories as $item)
                        <li class="list-inline-item"><a href="#c-{{$item}}">{{$item}}</a></li>
                    @endforeach
                </ul>
            </div>
        </div>
                ...
                @foreach ($listProduct as $category => $products)
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body listitem">
                            <a href="{{route('show-store-order-area',['code'=>$code,'productId' => $item['merchant_products_id'] ])}}">
