...
<html class="no-js" lang="en">
    <head>
        ...
        <link rel="manifest" href="/frontend-oobe-indonesia/assets/img/fav/site.webmanifest">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex flex-grow text-white">
                            ...
                            <div class="me-3 align-self-center">
                                ...
                                <div>
                                    <a href="{{route('profile-area',['code'=>$code])}}" 
                                        class="text-white">
                                        Setting Profile
                                    </a>
                                </div>
                        ...
                        <div class="nav mt-4 align-items-end">
                            <ul>
                                <li>
                                    <a href="{{route('index-area',['code'=>$code])}}">Home</a>
                                </li>
                                @if (auth()->user())
                                <!-- Register user menu -->
                                <li>
                                    <a href="{{route('my-order-index-area',['code'=>$code])}}">
                                        My Order
                                ...
                                <li>
                                    <a href="{{route('pp-area',['code'=>$code])}}">
                                        Privacy Policy
                                    </a>
                                </li>
                                <li>
                                    <a href="{{route('tnc-area',['code'=>$code])}}">
                                        Term & Condition
                                    </a>
                                </li>
                                @if (auth()->user())
                                    <li>
                                        <a href="{{route('logout-area',['code'=>$code])}}">
                                            Sign Out
                                        </a>
                                    </li>
                                @else
                                    <li>
                                        <a href="{{route('login-area',['code'=>$code])}}">
                                            Sign In
                                        </a>
                                    </li>
                                @endif
    ...
    <div class="modal-dialog  modal-fullscreen">
        <div class="modal-content">
            ...
            <div class="modal-body p-0 m-0">
                <iframe src="https://maps.google.com/maps?q={{$location->loc_lat}},
                {{$location->loc_lon}}&hl=es;z=14&amp;output=embed"
