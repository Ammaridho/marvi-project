...
@section('content')
    ...
    <form action="{{ route('profile-update-area',['code'=>$code]) }}" method="post">
        @csrf
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="flex-grow-1 me-1">
                                <div class="d-grid">
                                    ...
                                    onclick="location.href='{{route('index-area',['code'=>$code])}}';">
                                        Cancel
                                    </button>
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered ">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        <input type="text" class="f-inputbox" required="required" autocomplete="off"
    ...
    <script>
        ...
        $('#confirm-delete').on('click',function () {
            ...
            $.ajax({
                type: 'Delete',
                url: "{{ route('saved-address-delete-area',['code'=>$code]) }}",
        ...
        $('#store-address').on('click',function () {
            ...
            $.ajax({
                type: 'PUT',
                url: "{{ route('saved-address-update-area',['code'=>$code]) }}",
