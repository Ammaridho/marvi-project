        ...
        <div class="container-fluid container-xs">
            <div class="d-flex align-items-center justify-content-center vh-100">
                ...
                <div class="login-page form w-100">
                    ...
                    action="{{route('otp-area',['code'=>$code])}}" method="POST" autocomplete="off">
                    @csrf
                        <div class="text-white text-center mb-3 fw-normal">Join us it only takes few seconds.</div>
                        <div class="mb-3">
                            <input type="text" class="form-control input-login" required="required"
                            autocomplete="off" id="name" name="name" value="{{old('name')}}" placeholder="Your full name *" />
                            @if($errors->has('name'))
                         ...
                         <div class="mb-3">
                            ...
                            autocomplete="off" id="email" name="email" value="{{old('email')}}" placeholder="Email address *" />
                            @if($errors->has('email'))
                                <div role="alert" class="form-text alert alert-danger p-2">
                        ...
                        <div class="mb-3">
                            <input type="text" class="form-control input-login phone_with_ddd" required="required"
                        ...
                        <div class="mb-3 form-group password-group">
                            ...
                            required="required" autocomplete="off" id="password1" name="password" value=""
                            placeholder="Password *"  />
                            <a href="#!" class="password-visibility"><i class="fa fa-eye text-white"></i></a>
                        ...
                        <div class="mb-3 form-group password-group">
                            <input type="password" class="form-control input-login password-box"
                            required="required" autocomplete="off" id="password2" name="password_confirmation" value=""
                        ...
                        <div class="mt-4 text-center">
                            <a href="{{route('login-area',['code'=>$code])}}" class="btn-register btn-link text-white small">
