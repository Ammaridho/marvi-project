        ...
        <div class="row h-100 justify-content-center align-items-center">
            <div class="col-12 col-md-8">
              ...
              <div class="d-flex justify-content-between">
                  ...
                  <div class="small"><a href="javascript: void(0)" class="text-dark" data-bs-toggle="modal" data-bs-target="#modalCalendar"><u>More dates</u></a></div>
              </div>
                  ...
                  <div class="col-3 col-sm-3 col-md-3 text-center mb-2">
                    ...
                    <div class="form-group shadow">
                      <label class="date-radio-selection">
                            <input class="chooseDate setDate" type="radio" name="date" value="{{$dates['dmY'][$i]}}" />
