            ...
            <div class="row h-100 justify-content-center align-items-center">
                <div class="col-12 col-md-8">
                  ...
                  <div id="pod" class="d-none">
                    ...
                    <div class="mt-3">
                      <input type="text" autocomplete="off" class="inline-form vf-em-el" id="addr" name="addr" placeholder="Enter here">
                    </div>
                    <div class="mt-3">
                      <a id="submitDel" class="btn btn-theme-secondary text-white inputAddress inputData arrowDownSm">Next</a>
                    </div>
                  ...
                  <div id="pop" class="d-none">
                    ...
                    <div class="mt-3">
                      <div class="form-group choosePickup">
                          <label id="submitPickUp" class="option-radio-selection pickup shadow-sm mb-3 inputData"><input class="inputData arrowDownSm" type="radio" name="pickup" value="{{ $merchant->name }} at {{$merchant->address}}" />
