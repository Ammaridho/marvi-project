    ...
    <body class="mobile theme-default">
                ...
                <div class="modal-content">
                    ...
                    justify-content-between">
                        <div class="flex-grow-1">
                            <div class="d-grid">
                                <a href="{{route('payment-store-failed-store',['code'=>$code])}}" 
                        ...
                        <div class="flex-grow-1">
                            <div class="d-grid">
                                ...
                                onclick="location.href='{{route('payment-store-generate-qr-store',['code'=>$code,'data'=>json_encode($data)])}}';"
        ...
        <script>
            $(function(){
                ...
                setTimeout(function() {
                    window.location= ("{{route('payment-store-failed-store',['code'=>$code])}}");
                }, 180000);
                ...
                function checkPayment(){
                    $.ajax({
                        url: '{{route("check-payment-callback-store",["code"=>$code])}}',
                        type: "post",
                        data: {
                            "_token": "{{ csrf_token() }}",
                        ...
                        success: function (data) {
                            if (data == 1) {
                                var urlJavascript = "{{ route('payment-store-success-store',['code'=>$code]) }}";
