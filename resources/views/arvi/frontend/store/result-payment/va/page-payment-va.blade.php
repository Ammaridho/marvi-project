            ...
            <div class="container-fluid container-xs mt-2">
                <div class="mt-3">
                    ...
                    <div class="my-5 text-center">
                        <h6>PAY WITH</h6>
                        <img class="" 
                        src="/frontend-oobe-indonesia/assets/img/logo/logo-{{strtolower($data['payment']['channel_code'])}}.png">
                    </div>
            ...
            <div class="fixed-bottom bg-white border-top">
                <div class="container-fluid container-xs">
                    <div class="d-grid my-2">
                        ...
                        onclick="location.href='{{route('payment-store-generate-va',['data' => json_encode($data)])}}';">
