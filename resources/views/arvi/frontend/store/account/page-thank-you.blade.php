...
<html class="no-js" lang="en">
            ...
            justify-content-center vh-100">
                ...
                <div class="login-page form w-100">
                    ...
                    <div class="text-white my-4">
                         ...
                         <div>We will send you a confirmation email for new account, 
                            meanwhile you can find great 
                            <a href="{{route('index-store',['code'=>$code])}}" class="text-white">
    ...
    <script>
        $('#search-merchant, #searchSomething').on('keyup click',function () {
            let search = $(this).val();
            $.get("{{route('search-store',['code'=>$code])}}",{search:search},function (data) {
