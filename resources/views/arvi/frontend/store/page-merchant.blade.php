                ...
                @foreach ($listProduct as $category => $products)
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body listitem">
                            <a href="{{route('show-store-order-store',
                            ['code'=>$code,'productId' => $item['merchant_products_id'] ])}}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="text-center text-muted my-2">
                        <img src="/frontend-oobe-indonesia/assets/img/not-available-menu.png" 
                            ...
                            <div class="card-body listitem">
                                ...
                                <div class="d-flex align-items-center">
                                    <div>
                                        ...
                                        url('/frontend-oobe-indonesia/assets/img/menus/Izumi_thumb.jpg');"></div>
                                    </div>
                                    <div class="px-3">
                            ...
                            <div class="card-body listitem">
                                ...
                                <div class="d-flex align-items-center">
                                    <div>
                                        <div class="img-wrapper-sm" 
                                        style="background-image: 
                                        url('/frontend-oobe-indonesia/assets/img/menus/Oishimoo_thumb.jpg');"></div>
                                    </div>
                                    <div class="px-3">
                                        <div class="fw-bold"></div>
