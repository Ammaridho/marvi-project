...
<form id="form-process-payment" action="{{route("payment-process-store",["code"=>$code])}}" method="post">
    @csrf
    <section class="section-first">
        <div class="container-fluid container-xs mt-2">
            ...
            <input type="hidden" name="costDelivery" value="{{$cost_delivery}}">
    ...
    <section>
        <div class="container-fluid container-xs my-3 small">
          ...
          <a href="{{route('tnc-store',['code'=>$code])}}" data-bs-toggle="modal" data-bs-target="#modalTNC">
        ...
        <div class="modal-dialog  modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @include('arvi.frontend.store.check-out.termEndCondition')
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        $('#form-process-payment').on('submit',function () {
            ...
            if ($("input[type='radio']:checked.payment-methods").val()) {
                $("#form-process-payment input[name='cart']")
                .val(JSON.stringify(sessionStorage.getItem('cart-oobe-store')));
                document.getElementById('form-process-payment').submit();
            } else {
