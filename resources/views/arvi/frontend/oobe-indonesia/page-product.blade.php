...
@section('content')
    ...
    <section class="section-first">
        <div class="container-fluid container-xs px-2 pt-2">
            ...
            @endif
                <div class="mt-2 ms-2 ">
                    <a href="{{route('index-store-order',['merchantId' => $merchantId ])}}">
                        <div class="btn-back">
    ...
    <script>
        ...
        if ('{{$cartId}}' != '') {
            var oldCart = JSON.parse(sessionStorage.getItem('cart-oobe-indonesia'))['{{$cartId}}'];
            if (oldCart != null) {
        ...
        $('#add-to-cart').on('click',function () {
            ...
            let nameCart = 'cart-oobe-indonesia';
