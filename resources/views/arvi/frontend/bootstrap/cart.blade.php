        ...
        <input type="hidden" name="idProduct[]" class="idProductt" value="{{$item['pid']}}">
            <div class="d-flex">
                ...
                <div class="thumbnail-cart" style="background-image: 
                    url('/arvi/assets/img/products/{{$item[$item['pid']]['productImage']}}.{{$item[$item['pid']]['productImageType']}}');">
                </div>
                </div>
                <div class="p-1 w-100">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="counter-sm number">
                        <span class="minuss mr-1" data-id="{{$item[$item['pid']]['productId']}}" 
                        data-name="{{$item[$item['pid']]['productName']}}"><i class="fa fa-minus" 
                        aria-hidden="true"></i></span>
                        <input type="number" name="qtyProduct[]" value="{{$item[$item['pid']]['productQuan']}}" 
                        class="input-numberr tc-qty-prod" max="99" min="1" readonly />
...
<div class="modal-footer">
    <div class="tests"></div>
    <button type="button" class="btn btn-theme-secondary col arrowDownSmC inputData" 
    id="btnProceedCheckout" data-bs-dismiss="modal" aria-label="Close">
        Proceed to Checkout
    </button>
</div>
