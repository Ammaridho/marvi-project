...
@section('content')
    ...
    align-items-center h-100 page-xs">
        <div class="row text-center d-flex align-items-center p-4">
            ...
            <div class="card no-border">
                <div class="card-body border-0 py-4">
                    <div class="mb-4">
                        <img src="/arvi/assets/img/small-cross-mark.svg" type="image/svg+xml" class="w-25" />
                    </div>
                    <h2>We're really sorry.</h2>
                    <div>Your order failed to be proccess.</div>
                    ...
                    <div class="mt-3 small">
                        Please check your junk/spam email folder just incase the confirmation 
