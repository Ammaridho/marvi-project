...
<head>
    ...
    <meta name="description" content="The Best Cold Brew Coffee in Singapore. 
    A specialty coffee company brewing fresh daily.">
    ...
    <script>
        ...
        function gtag(){dataLayer.push(arguments);}
            gtag('js', new Date());gtag('config', '{{ env('GA_CONFIG') }}');
    </script>
