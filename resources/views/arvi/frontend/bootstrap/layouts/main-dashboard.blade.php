...
<html lang="en" data-assets-path="assets/">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Public+Sans:ital,wght@0,300;
    0,400;0,500;0,600;0,700;1,300;1,400;1,500;1,600;1,700&display=swap" rel="stylesheet" />
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            ...
            menu-link text-large ms-auto d-block d-xl-none">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item"> 
              <a href="page-report-orders.php" class="menu-link"> 
                <i class="menu-icon tf-icons bx bx-store-alt"></i> 
                <div data-i18n="Order">Orders</div>
              </a>
            </li>
            <li class="menu-item"> 
              <a href="page-report-production-plan.php" class="menu-link"> 
                <i class="menu-icon tf-icons bx bx-calendar-check"></i> 
                <div data-i18n="Order">Production Plans</div>
              </a>
            </li>
            <li class="menu-item"> 
              <a href="page-report-delivery-drop-point.php" class="menu-link"> 
                <i class="menu-icon tf-icons bx bx-package"></i> 
                <div data-i18n="Order">Delivery Drop Point</div>
              </a>
            </li>
            <li class="menu-header small text-uppercase">
            ...
            <li class="menu-item"> 
              <a href="page-product-list.php" class="menu-link"> 
                <i class="menu-icon tf-icons bx bx-list-ul"></i> 
                <div data-i18n="Order">List of Products</div>
              </a>
            </li>
          </ul>
        </aside>
