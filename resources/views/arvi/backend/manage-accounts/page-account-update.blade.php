                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    placeholder="Enter active mobile number" autocomplete="off"
                                    value="{{isset($dataUser['phone_number'])?
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-check mb-2">
                                    <input class="form-check-input choose-brands" type="checkbox"
                                    name="brand[]" value="{{$item->id}}" id="b-{{$item->id}}">
...
<script>
    ...
    var jArrayBrand_id = <?php echo json_encode(json_decode($dataRelationBrands)); ?>;
    ...
    $('#manageStore').on('submit',function () {
        ...
        if ($("input[value='admin']").is(':checked') || $("input[value='viewer']").is(':checked')) {
            if($('input[name="brand[]"]').is(':checked')){
                $.ajax({
                    type: 'PUT',
                    url: "{{ route('account-update',['companyCode' => $companyCode]) }}",
                    data: $(this).serialize(),
