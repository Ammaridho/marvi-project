                                ...
                                <div class="mb-3 container-count">
                                    ...
                                    <div class="mb-3">
                                        @if ($productCategory->category_type == 'fixed')
                                            ...
                                            autofocus maxlength="15" readonly>
                                        @else
                                            <input type="text" class="form-control" 
                                            id="inputCount" name='name' 
                                            value="{{$productCategory->category_name}}" 
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    <div>
                                        ...
                                        <select class="form-select store-avaibility merchants" 
                                        name="merchants" id="multiple" multiple="multiple"
                                        style="width: 100%;">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body center p-3">
                <h4>You're about to 
                    <span class="text-danger">remove</span> this item.
                </h4>
...
<script>
    ...
    $('#submit-delete').on('click',function () {
        ...
        $.ajax({
            type: 'DELETE',
            url: "{{ route('brand-category-destroy',['companyCode' => $companyCode]) }}",
            data: {
                "id": id,
                "_token": token,
            },
    ...
    $('#form-categories').on('submit',function () {
        ...
        storeAvaibilityData = JSON.stringify($("select[name='merchants']").val());
        $.ajax({
            type: 'POST',
