                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                You can create Brand Extra Attribute which will be available to all your Store.
                            </div>
                            <div>
                                <a href="javascript:void(0);" class="btn btn-primary text-nowrap"
                                id="add-extra-attribute" data-id="{{$brand_id}}">
                        ...
                        <div class="d-flex justify-content-end align-items-center mt-4">
                            <div class="text-muted small me-3">
                                ...
                                <span id="much-display">
                                    {{DB::table('brand_extra_attributes')->where('brand_id',$brand_id)->count() < 25 ?
                                    DB::table('brand_extra_attributes')->where('brand_id',$brand_id)->count() : 25}}
                                </span>
                                from {{DB::table('brand_extra_attributes')->where('brand_id',$brand_id)->count()}}
                            </div>
                            <div class="">
...
<script>
    ...
    $('.filter-data').on('change',function () {
        ...
        $.get("{{route('brand-extra-attribute-list-table',['companyCode' => $companyCode])}}",
        {brand_id:brand_id,much:much},function (data) {
    ...
    $('.edit-extra-attribute').on('click',function () {
        let id = $(this).data('id');
        $.get("{{route('brand-extra-attribute-edit',['companyCode' => $companyCode])}}",
    ...
    $('#add-extra-attribute').on('click',function () {
        ...
        $.get("{{route('brand-extra-attribute-create',['companyCode' => $companyCode])}}",
