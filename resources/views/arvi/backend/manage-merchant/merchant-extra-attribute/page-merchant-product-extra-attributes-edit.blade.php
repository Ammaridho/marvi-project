                ...
                <div class="col-lg-7 col-md-8 col-12">
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <hr>
                            <div class="row">
                                <input type="hidden" name="id" value="{{$merchantExtraAttribute->id}}">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="mb-3 container-count">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            name="name" value="{{$merchantExtraAttribute->name}}" autofocus maxlength="40" required autocomplete="off">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="mb-3">
                                        ...
                                        name="fee" value="{{$merchantExtraAttribute->fee}}" id="extraPrice" autocomplete="off">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="mb-3">
                                        ...
                                        name="sku" value="{{$merchantExtraAttribute->sku}}">
                                        <div id="storeNumberHelp" class="form-text text-danger
                                        d-none">Error message here.</div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="mb-3">
                                        <label for="extraPrice" class="form-label">Weight (Kg) *</label>
                                            ...
                                            name="weight" value="{{$merchantExtraAttribute->weight}}" autocomplete="off">
                                        <div id="storeNumberHelp" class="form-text text-danger
                                        d-none">Error message here.</div>
                                    </div>
                                </div>
                        ...
                        <div class="row justify-content-start">
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="d-grid">
                                    ...
                                    data-id="{{$merchantExtraAttribute->id}}">Remove category</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    $( document ).ready(function() {
        // old uom
        let uom = "{{$merchantExtraAttribute->uom}}";
        if (uom != '') {
    ...
    $('#submit-delete').on('click',function () {
        ...
        $.ajax({
            type: 'DELETE',
            url: "{{ route('extra-attribute-destroy',['companyCode' => $companyCode]) }}",
            data: {
                "id": id,
                "_token": token,
            },
