            ...
            <div class="col-lg-7 col-md-8 col-12">
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h4 class="m-0">
                                    <span class="text-muted">Manage Store</span>/ {{$dataMerchant->name}} / Store Details
                                </h4>
                            </div>
                            <div>
                        ...
                        <hr>
                        <div class="row">
                            <input type="hidden" name="merchant_id" value="{{$dataMerchant->id}}">
                            <div class="col-12">
                                <div class="mb-3">
                                    <label for="brandSelect" class="form-label">Brand *</label>
                                    <div>
                                        <select class="form-select default-select-single" 
                                        name="brand_id" id="brand" style="width: 100%;" required>
                                            <option selected="true" disabled="disabled">{{$dataMerchant->brand->name}}</option>
                            ...
                            <div class="col-lg-4 col-md-4 col-12">
                                <div class="mb-3">
                                    ...
                                    name="phone_number" value="{{$dataMerchant->phone_number}}" 
                                    id="storeNumber" required>
                            ...
                            <div class="col-lg-8 col-md-8 col-12">
                                <div class="mb-3">
                                    ...
                                    <div>
                                        ...
                                        <option selected="true" disabled="disabled">{{$dataMerchant->loc_tz}}</option>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    required>{{$dataMerchant->description}}</textarea>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <a class="upload-image" href="javascript:void(0)">
                                        @if (isset($dataMerchant->image_url))
                                            <div class="border bg-light m-1 rounded d-flex 
                                                ...
                                                id="image-preview">
                                                    <img src="/storage/arvi/backend-assets/img/logo/merchants/{{
                                                        $dataMerchant->image_url}}" 
                                                    id="preview" class="img-thumbnail">
                                                </div>
                                            </div>
                                        @else
                                            <div class="lazy store-cover border bg-light m-1 rounded 
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    <div class="form-group">
                                        ...
                                        name="storeLocation" style="width: 100%;">
                                            <option selected="true" disabled="disabled">
                                                {{$dataMerchant->location->first()->name}}
                                            </option>
                                            @foreach ($locations as $item)
                                                <option value="{{$item}}" data-id="{{$item->id}}">
                                                    {{$item->name}}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="mb-3">
                                    <label for="storeBulding" class="form-label">Building/suite</label>
                                    <input type="text" class="form-control" name="building_suite" 
                                    value="{{$dataMerchant->building_state}}" id="storeBulding">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    value="{{$dataMerchant->city}}" id="storeCity">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    value="{{$dataMerchant->state}}" id="storeState">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    name="postal_code" value="{{$dataMerchant->postal_code}}" 
                                    id="storePostal">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="mb-3">
                                    <label for="merchantCountry" class="form-label">
                                        Country * 
                                    </label>                                            
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <hr>
                        <div class="mb-3">Set up and configure order types to suit the needs of 
                            your business.</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-8">
                                <div class="mb-3">
                                    ...
                                    name="warehouse_id" value="{{$dataMerchant->warehouse_id}}" 
                                    id="warehouseID" autocomplete="off">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            ...
                                            value="/storage/app/analytics/{{$dataMerchant->ga_app_credential_json}}">
                                            <div class="text-center">
                                                <small class="text-primary">{{$dataMerchant->ga_app_credential_json}}</small>
                                            </div>
                                            <div id="storeBuldingHelp" class="form-text text-danger d-none">
                                                Error message here.
                                            </div>
                                        ...
                                        <div class="col-4">
                                            ...
                                            id="gaCode" value="{{$dataMerchant->ga_code}}" autocomplete="off" 
                                            placeholder="G-">
                                            <div id="storeBuldingHelp" class="form-text text-danger d-none">
                                                Error message here.
                                            </div>
                                        ...
                                        <div class="col-4"><label for="propertyId" class="form-label">Property Id</label>
                                            ...
                                            id="propertyId" value="{{$dataMerchant->ga_property_id}}" autocomplete="off" 
                                            placeholder="123...">
                                            <div id="storeBuldingHelp" class="form-text text-danger d-none">
                                                Error message here.
                                            </div>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="my-2">
                                    Add social media links to your merchant navigation so customers 
                    ...
                    <div class="row justify-content-start">
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="d-grid">
                                ...
                                data-bs-toggle="modal"
                                data-id="{{$dataMerchant->id}}" data-bs-target="#modaldDefaultDelete">
                                    Remove store
                                </button>
                            </div>
                        </div>
        ...
        <div class="modal-body ps-4 bg-light">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <div>Allow customers to place orders for delivery to their preferred 
                        address.</div>
                </div>
                <div>
                    <div class="form-check form-switch">
                        ...
                        data-bs-parent="#listOptions-2" style="">
                            <div class="accordion-body">
                                <div class="form-check">
                                    ...
                                    type="checkbox" name="support_pickup_min_order_amount" 
                                ...
                                <div class="mt-2 hidden toggle-minimum-order-info-pickup">
                                    <div class="input-group">
                                        ...
                                        value="{{isset($dataMerchant->pickup_min_order_amount)?
                                        $dataMerchant->pickup_min_order_amount:''}}">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!-- Modal add social -->
<div class="modal fade" id="modalSocials" aria-labelledby="modalSocials" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body center p-3">
                <h4>You're about to <span class="text-danger">remove</span> this Store.</h4>
                <div class="">By doing this action, you will removed the Store and cannot be
                     undone.
                </div>
            </div>
            <div class="modal-footer border-top pb-2">
...
<script>
    ...
    $( document ).ready(function() {
        ...
        // integration to lodi
        if("{{$dataMerchant->sent_order_to_lodi}}" == 1){
            $("input[name=sent_order_to_lodi]").trigger('click');
        }
        ...
        // hide form image
        $('.file').hide();
        let brand_id = "{{$dataMerchant['brand_id']}}";
        if (brand_id != '') {
            $(`#brand option[value="${brand_id}"]`).attr('selected','selected');
        }
        let loc_tz = "{{$dataMerchant['loc_tz']}}";
        if (loc_tz != '') {
            $(`#merchantTimezone option[value="${loc_tz}"]`).attr('selected');
        }
        let storeLocation = 
            "{{$dataMerchant->location->first()?$dataMerchant->location->first()->id:''}}";
        if (storeLocation != '') {
            $(`#storeLocation option[data-id="${storeLocation}"]`).attr('selected','selected');
        }
        let country = "{{$dataMerchant['country']}}";
        if (country != '') {
            $(`#merchantCountry option[value="${country}"]`).attr('selected','selected');
        }
        //old social media
        ...
        // set old data fulfilment
        // check support delivery
        if("{{$dataMerchant->support_delivery}}" == 1){
            $('input[name=support_delivery]').trigger('click');
        }
        if("{{$dataMerchant->support_pickup}}" == 1){
            $('input[name=support_pickup]').trigger('click');
        }
        // old delivery method 
        var jArray_id = <?php echo json_encode(json_decode($deliveryMethods)); ?>;
        if (jArray_id != null) {
            //set checkbox delivery
            jArray_id.forEach(element => {
                $(".delivery_option:input[value="+element['arvi_delivery_id']+"]")
                .prop( "checked", true );
                $(".delivery_option:input[value="+element['arvi_delivery_id']+"]")
                .siblings(".delivery_option_id").val(element['transporter_id']);
                $(".sub_delivery_option:input[value="+element['arvi_sub_delivery_id']+"]")
                .prop( "checked", true );
            });
        }        
        //support delvery minimum order amount
        if("{{$merchantDelivery['support_delivery_min_order_amount']}}" == 1){
            $('input[name=support_delivery_min_order_amount]').trigger('click');
        }
        //support pickup minimum order amount
        if("{{$dataMerchant['support_pickup_min_order_amount']}}" == 1){
            $('input[name=support_pickup_min_order_amount]').trigger('click');
        }        
    });
    ...
    $('#submit-delete').on('click',function () {
        ...
        $.ajax({
            type: 'DELETE',
            url: "{{ route('manage-store-destroy',['companyCode' => $companyCode,'merchantId' => $dataMerchant->id]) }}",
            data: {
                "id": id,
                "_token": token,
            },
        ...
        if (!$('#modalSetupPickup,#modalSetupDelivery').is(':visible')) {
            ...
            if ($("select#merchantBrand").val() == 'Select') {
                ...
                if($("input[name='support_delivery']").is(':checked')){
                    ...
                    var delivery_options = $("input[name='delivery_option']:checked").map(function(){
                        return this.value;
                    }).get();
                    ...
                    if (sub_deliveries.length > 0) {
                        let locationId = JSON.parse($("select[name='storeLocation']").val())['id'];
