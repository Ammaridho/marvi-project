        ...
        <div class="col-lg-7 col-md-8 col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="mb-3 container-count">
                                ...
                                <div class="mb-3">
                                    ...
                                    value="{{$location['name']}}" id="inputCount" 
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="mb-3">
                                ...
                                value="{{$location['address']}}" id="locAddr" required 
                                autocomplete="off" >
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="mb-3">
                                ...
                                value="{{$location['building_suite']}}" id="locBulding" required 
                                autocomplete="off" >
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="mb-3">
                                ...
                                value="{{$location['city']}}" id="locCity" required autocomplete="off" >
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="mb-3">
                                ...
                                value="{{$location['state']}}" id="logState" autocomplete="off" >
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="mb-3">
                                ...
                                id="logPostal" required autocomplete="off" >
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="mb-3">
                                ...
                                name="lat" value="{{$location['loc_lat']}}" 
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control noArrow number-lat-lon" 
                                name="lon" value="{{$location['loc_lon']}}"
                                required autocomplete="off" >
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control noArrow" id="description" name="description" 
                                rows="2" autofocus maxlength="300">{{$location['description']}}</textarea>
                        ...
                        <div class="col-12">
                            <div>Maximum accept orders radius *</div> <div class="me-2" id="set-radius"></div>
                            <div style="font-size: 13">Set the maximum straight line distance that 
                                you will accept orders to. 
                                This distance forms the accepted area radius around location.</div>
                            <div class="input-group">
                                <input type="text" class="form-control noArrow numbers" 
                                name="loc_aware_tolerance" 
                                value="{{$location['loc_aware_tolerance']}}" aria-label="" required>
            ...
            <div class="my-3">
                <div class="row justify-content-start">
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="d-grid">
                            <button type="button" class="btn btn-danger  delete-location"
                            data-id="{{$location['id']}}">Remove location</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $( document ).ready(function() {
        // old data location category
        var location_type = <?php echo $location['location_type']; ?>;
        if (location_type != null) {
            var aa = [];
            location_type.forEach(element => {
                aa.push(element);
            });
            $('.location-categories').select2({
                multiple: true,
            });
            $('.location-categories').select2().val(aa).trigger('change.select2');
            $("#multiple").val(aa);
        }
        let country = "{{$location['country']}}";
        if (country != '') {
            $(`#locationCountry option[value="${country}"]`).attr('selected','selected');
        }
    });
    ...
    $('#submit-delete').on('click',function () {
        ...
        $.ajax({
            type: 'DELETE',
            url: "{{ route('location-destroy',['companyCode' => $companyCode]) }}",
            data: {
                "id": id,
                "_token": token,
            },
